package cn.captainshen.activiti;
...
public class  ActivitiUtil{
    ...
    public static void deployProcess(String name) {
     ...
     * @Return 任务ID
     */
    public static String queryTaskByAssignee(String assignee) {
    ...
    private static void turnTransition(String taskId, String activityId,
                                       Map<String, Object> variables) throws Exception {
        System.out.println(taskId + " " + activityId);
        // 当前节点
    ...
    public static void endProcess(String taskId) throws Exception {
        ActivityImpl endActivity = findActivitiImpl(taskId, "endEvent");
    ...
    public static List<ProcessDefinition> queryAllDefinitions(){
        return repositoryService.createProcessDefinitionQuery().list();
    }

    public static ProcessDefinition queryDefinitionByKey(String processKey){
    ...
    public static String queryUserGroupByUserId(String userId){
        return identityService.createGroupQuery().groupMember(userId).singleResult().getId();
    }

    public static void main(String[] args) {
//        // 获取所有流程定义
//        List<ProcessDefinition> processDefinitions = queryAllDefinitions();
...
//        }
//        // 获取表单数据
//        ProcessDefinition processDefinition = ActivitiUtil.queryDefinitionByKey("fundApply");
